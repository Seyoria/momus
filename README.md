...
### Admin Paneli (v2.0)
- **11 Yönetim Sekmesi:**
  - Profil Yönetimi — tüm profilleri görüntüle, düzenle, sil
  - Rozet Sistemi — OG, Verified, Premium, Dev, özel ikon rozetleri
  - Süreli Rozetler — Otomatik sona eren geçici rozetler
  - Öne Çıkan Profiller — spotlight profiller
  - Kullanıcı Yasaklama — ban listesi yönetimi
  - Davet Kodu Sistemi — kayıt için davet kodu zorunluluğu
  - Bakım Modu — tek tıkla siteyi bakıma al
  - Changelog Gönderici — Discord kanalına güncelleme duyurusu
  - Genel Duyuru Bandı — site geneli countdown'lu duyuru
  - İstatistikler — KPI kartları, en çok görüntülenen profiller
  - İşlem Günlüğü (Audit Logs) — tüm admin aksiyonlarının kaydı
- **Hızlı Aksiyonlar:** JSON yedekleme, boş hesap tarama, acil duyuru
- **4 KPI Stat Kartı:** Kayıtlı profil, toplam görüntülenme, öne çıkan profil, aktif rozet

### Bulut Altyapısı
- **Supabase Database** — Profil verileri anlık bulut senkronizasyonu
- **Supabase Storage** — Medya dosyaları (arka plan, müzik, avatar) bulut depolama
- **IndexedDB Fallback** — Yerel önbellek desteği
- **Anlık Yükleme** — Dosya seçildiği an buluta yüklenir, kaydet butonuna gerek yok
