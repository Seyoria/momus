<div align="center">
  <h1>✦ momus</h1>
  <p><strong>Modern, Minimalist & Gelişmiş Bio-Link Platformu</strong></p>
  <p>
    <a href="https://seyoria.github.io/momus/">Canlı Siteyi Ziyaret Et</a> •
...
* **🛠️ Gelişmiş Özelleştirme Paneli (Dashboard):** Arka plan (GIF, MP4, Görsel), müzik, profil opaklığı, bulanıklığı ve özel renk seçiciler.
...
* **Veritabanı & Depolama:** [Supabase](https://supabase.com/) & IndexedDB
* **Bot & API:** Node.js, Express, Discord.js v14

## 📄 Lisans
Bu proje tüm hakları saklıdır. &copy; 2026 momus.
